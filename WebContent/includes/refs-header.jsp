	<header>
	  <div class="container_12">
	    <div class="grid_12">
	      <h1><a href="<%=request.getContextPath()%>/index.jsp"><img src="<%=request.getContextPath()%>/images/logo.png" alt=""></a></h1>
	      <div class="clear"></div>
	    </div>
	    <div class="menu_block">
	      <nav>
	        <ul class="sf-menu">
	          ...
	          <li><a href="<%=request.getContextPath()%>/cliente/CabanaOCasaCRUD?cmd=listar">Búsqueda</a></li>
