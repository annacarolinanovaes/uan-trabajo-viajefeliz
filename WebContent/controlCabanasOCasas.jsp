	    ...
	    <div class="grid_12 back">
			...
			<div class="container_12">
				<div class="grid_12" style=" position: relative; left: 5%;">
			      <h3 style=" position: relative; left: -5%;">Control Arrendatario</h3>		
			        <p>¡Sea bienvenido! Este sitio todavía está en desarrollo, siendo así separamos por actor los casos de uso. Mantente atento al siguiente listado:</p><br /> <br />	
						<ul class="list-group" style=" width: 70%;">
							<li class="list-group-item"><a href="<%=request.getContextPath()%>/cliente/ArrendatarioCRUD?cmd=novo">Registro de Arrendatario</a></li>
							<li class="list-group-item"><a href="<%=request.getContextPath()%>/cliente/ArrendatarioCRUD?cmd=listar">Listar todos los Arrendatarios</a></li>
						 	...
						 	<li class="list-group-item"><a href="<%=request.getContextPath()%>/cliente/AlquilerCRUD?cmd=listar">Listar todos los Alquileres</a></li>			
						</ul>		            
