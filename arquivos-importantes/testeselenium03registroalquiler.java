...
public class testesselenium03registroalquiler {
	...
	@Test
	public void testTestesselenium03registroalquiler() throws Exception {
		...
		selenium.waitForPageToLoad("30000");
		selenium.type("id=fechaInicio", "01-03-2018");
		selenium.type("id=fechaFin", "02-03-2018");
		selenium.type("id=cantidadPersonas", "2");
		selenium.type("id=codUsuario", "1");
